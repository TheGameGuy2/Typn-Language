...
<h2>How to use it</h2>
<p>Build the project yourself or go to "Dist" for the compiled binaries. <br>
The binaries for the compiler and runtime are only available for Linux right now.</p>
<p>To build Typn yourself, you'll need a C++ compiler supporting label pointers (g++, clang) and C# with .Net. The compiler is written in C#, the cs-project can be found in "Compiler".<br>
The VM is generated by "VMGenerator.py" inside "Compiler/Utils/", you can directly compile the generated C++ files inside "VM".<br>
